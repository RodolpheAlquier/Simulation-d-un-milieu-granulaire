...
Vecteur operator+(const Vecteur& vecteur1,const Vecteur& vecteur2){
    return Vecteur(vecteur1.x + vecteur2.x , vecteur1.y + vecteur1.y  );
}
...
Vecteur operator*(const Vecteur& vecteur1,const Vecteur& vecteur2){
    return (vecteur1.x * vecteur2.x + vecteur1.y * vecteur1.y  );
}

Vecteur operator*(double a, const Vecteur& vecteur1){
    return Vecteur(a*vecteur1.x , a* vecteur1.y);
}
...
Grain::Grain(double r0 double rayon0, double rho0){ //Construction d'un point
    ...
    rayon=rayon0;
    rho=rho0;
    m=(4/3.) * PI() * rho*rayon*rayon*rayon
}
